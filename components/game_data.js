...
export class GameData {
  constructor() {
    this.items_game_url =
      'https://raw.githubusercontent.com/csfloat/cs-files/master/static/items_game.txt'
    this.items_game_cdn_url =
      'https://raw.githubusercontent.com/csfloat/cs-files/master/static/items_game_cdn.txt'
    this.csgo_english_url =
      'https://raw.githubusercontent.com/csfloat/cs-files/master/static/csgo_english.txt'
    this.schema_url =
  ...
  update() {
    ...
    downloadFile(this.items_game_url, (data) => {
      if (data) {
    ...
    downloadFile(this.csgo_english_url, (data) => {
      if (data) {
    ...
    downloadFile(this.items_game_cdn_url, (data) => {
      if (data) {
    ...
    downloadFile(this.schema_url, (data) => {
      if (data) {
